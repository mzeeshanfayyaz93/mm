  ...
  return (
    <section className="bg-white">
      <div className="max-w-6xl mx-auto text-center py-10 md:py-20 px-4 bg-[url(/about/bg-2.webp)] bg-cover bg-center">
        {/* Title */}
        <h2 className="text-2xl md:text-4xl xl:text-6xl font-bold text-[#080a62] mb-4 max-w-3xl mx-auto">{title}</h2>
        
        {/* Description */}
        <p className="text-lg text-gray-600 mb-6 max-w-xl mx-auto py-5">
        {description}
        </p>
